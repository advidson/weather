...
//    // The directory the application uses to store the Core Data store file. This code uses a directory named "advidson.Weather" in the application's documents directory.
...
#pragma mark first launch prepare
- (void)initAppData {
    if(![[NSUserDefaults standardUserDefaults] boolForKey:@"HasLaunchedOnce"]) {
        ...
        NSError *err = nil;
        NSString *dataPath = [[NSBundle mainBundle] pathForResource:@"city_ru" ofType:@"json"];
        NSArray *cities = [NSJSONSerialization JSONObjectWithData:[NSData dataWithContentsOfFile:dataPath]
                                                          options:kNilOptions
                                                            error:&err];
        [[DataProvider sharedData] addCities:cities];
    }
}
